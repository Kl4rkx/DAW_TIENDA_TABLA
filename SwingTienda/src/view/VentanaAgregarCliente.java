...
public class VentanaAgregarCliente extends JFrame {
	...
	public VentanaAgregarCliente() {
		...
		inputDireccion.setBorder(new BevelBorder(BevelBorder.LOWERED, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO));
		inputDireccion.setColumns(10);
		inputNombre.setBackground(COLOR_CAMPO);
		inputNombre.setBorder(new BevelBorder(BevelBorder.LOWERED, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO));
		inputNombre.setColumns(10);
		inputId.setBackground(COLOR_CAMPO);
		inputId.setBorder(new BevelBorder(BevelBorder.LOWERED, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO));
		...
		inputCp.setBorder(new BevelBorder(BevelBorder.LOWERED, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO));
		...
		inputTelefono.setBorder(new BevelBorder(BevelBorder.LOWERED, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO, COLOR_BORDE_CAMPO));
